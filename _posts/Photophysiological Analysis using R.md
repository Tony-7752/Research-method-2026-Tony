...
---
### 23/06/2026
# Photophysiological Analysis using R
...
* Field sampling - We went to Sdot Yam beach, and gathered algae samples for PAM analysis.
* Data analysis - After we  recieved raw data, we had a workshop where we analysed the results in R.
