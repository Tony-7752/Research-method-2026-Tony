...
setwd("C:/Users/tt775/OneDrive/Desktop/Courses/research-methods")
...
light_ETR <- light_PAM[, c("Date", "Time", "PAR", "ETR1","ETR2","ETR3","ETR4","ETR5","ETR6","ETR7","ETR8","ETR9","ETR10","ETR11","ETR12","ETR13")]
str(light_ETR)
